    ...
    return (
        <div className="mt-24 mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 justify-center gap-6 mt-8">
                <div className=" shadow-xl bg-base-100  animate__animated animate__backInLeft animate__slow" >
                        ...
                        <div className="absolute top-1/3 w-full flex flex-col justify-center items-center ">
                            <div className=" w-full p-5 ">
                                ...
                                <div className="flex justify-center">
                                    <Link to='/contact'><button  className="btn bg-green-500 btn-sm text-lg font-semibold animate__animated  animate__flip animate__slow">Contact</button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="bg-base-100 shadow-x animate__animated animate__backInDown animate__slow" >
                    <div className="relative  w-full">
            ...
            {/* mosque */}
                <div className="bg-base-100 shadow-x animate__animated animate__backInRight animate__slow" >
                    <div className="relative  w-full">
